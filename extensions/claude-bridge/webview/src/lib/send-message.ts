 ...
 *  webview deliberately sends one semantic frame: splitting clear and submit
 *  across two WS frames left a race where maintenance could occupy the prompt
 *  between them. `promptReady` still flips optimistically so Send becomes Stop
