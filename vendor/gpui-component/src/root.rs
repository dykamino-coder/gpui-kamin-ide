...
pub struct Root {
    ...
    /// KaminIDE patch: overlay windows must NOT paint theme background
    /// (transparent click-through layer over the main window).
    ...
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        window_border().child(
            div()
                ...
                .when(!self.transparent, |d| d.bg(cx.theme().background))
