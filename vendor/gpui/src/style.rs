...
pub struct TextStyle {
    ...
    /// KaminIDE patch: трекинг (`letter-spacing`), пиксели. 0 = как было.
    /// Доходит до глифов только у ОДНОСТРОЧНОГО текста без переноса —
    /// см. `layout_wrapped_line_spaced` (план 99).
